...
- [x] T016 [US1] Add the AL2023 On-Demand managed node group, encrypted gp3 launch template, IMDSv2, no-SSH posture, node repair, and `2/2/4` capacity bounds in `aws/modules/environment-foundation/eks.tf`
