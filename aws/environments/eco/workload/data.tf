# What the eco/workload root reads rather than creates (PC-IAC-017): the network of
# eco/networking and the roles, keys, and security groups of eco/security, each found by its
# standard name.
...
data "aws_subnets" "private" {
  ...
  lifecycle {
    postcondition {
      ...
      error_message = "The cluster needs private subnets in at least two Availability Zones, and eco/networking tags one per zone."
    }
  }
}
