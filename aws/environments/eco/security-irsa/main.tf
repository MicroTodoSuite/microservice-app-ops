# The eco/security-irsa root: the second security pass PC-IAC-022 records for IRSA, after
# eco/workload creates the cluster. It registers the cluster's OIDC issuer in IAM and creates
