# What the eco/security-irsa root reads rather than creates (PC-IAC-017): the OIDC issuer of
# eco/workload's cluster and the secret containers of eco/security, by standard name.
