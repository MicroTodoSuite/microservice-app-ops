# Names, policies, security group rules, and tags of the eco/security root, built here and
...
locals {
  ...
  # Amazon EKS names the control-plane log group itself; eco/workload creates it first.
