...
output "vpc_id" {
  description = "full-dev VPC id. The spoke's own transit gateway attachment is created against this VPC."
  value       = module.foundation.vpc_id
}

output "vpc_cidr" {
  description = "full-dev address space. The hub installs its return route to exactly this range."
