# Inputs of the fstg/workload root. Values come from the gitignored fstg.tfvars; the account is
...
variable "environment" {
  type        = string
  description = "Environment code, from MTS-IAC-101. This root is the full-staging environment's workload."
