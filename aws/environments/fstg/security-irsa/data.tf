# What the fstg/security-irsa root reads rather than creates (PC-IAC-017): the OIDC issuer of
# fstg/workload's cluster and the secret containers of fstg/security, by standard name.
