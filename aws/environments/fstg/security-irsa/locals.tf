# Names, trust and permission policies, and tags of the fstg/security-irsa root, built here and
...
locals {
  ...
  # The AWS Load Balancer Controller's identity (ops spec 004 T031). Its permissions are the
