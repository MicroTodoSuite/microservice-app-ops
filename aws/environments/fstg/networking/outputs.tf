# Outputs consumed by fstg/security and fstg/workload, and by the operators.
output "vpc_id" {
  description = "ID of the fstg spoke VPC."
  value       = module.network.vpc_id
}

output "vpc_cidr" {
  description = "IPv4 CIDR block of the fstg spoke."
