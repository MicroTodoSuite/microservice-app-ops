# Inputs of the fstg/networking root. Account, region, zones, and CIDRs are
...
variable "environment" {
  ...
  validation {
    ...
    error_message = "This root builds fstg only. Another environment would create a second spoke from fstg's state key."
  }
}
...
variable "vpc_cidr" {
  type        = string
  description = "IPv4 address space reserved for the fstg spoke."
