# The fprd/workload root, third in the PC-IAC-022 order: the full-production cluster, its managed
# add-ons, and the bootstrap node group. The roles, keys, security groups, and subnets
# come from fprd/security and fprd/networking.
module "eks_cluster" {
...
# and fprd/security's node group, for node-to-node traffic and egress.
...
# fprd/networking and fprd/security put on them.
