# What the fprd/workload root reads rather than creates (PC-IAC-017): the network of
# fprd/networking and the roles, keys, and security groups of fprd/security, each found by its
# standard name.
...
data "aws_subnets" "private" {
  ...
  lifecycle {
    postcondition {
      ...
      error_message = "The cluster needs private subnets in at least two Availability Zones, and fprd/networking tags one per zone."
    }
  }
}
