...
variable "endpoint_public_access_cidrs" {
  type        = list(string)
  description = "Operator addresses allowed to reach the public API endpoint, each a /32 block; [] keeps the API private. Real addresses belong only in the gitignored fprd.tfvars."
