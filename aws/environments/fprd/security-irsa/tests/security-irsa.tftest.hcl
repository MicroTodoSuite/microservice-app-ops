...
run "builds_the_irsa_names" {
  ...
  assert {
    condition     = local.oidc_provider_name == "lex-mts-fprd-oidc-eks" && local.irsa_role_names == { jwtdev = "lex-mts-fprd-role-jwtdev", jwtstg = "lex-mts-fprd-role-jwtstg", obssecret = "lex-mts-fprd-role-obssecret", secsecret = "lex-mts-fprd-role-secsecret", trivyecr = "lex-mts-fprd-role-trivyecr", kyvernoecr = "lex-mts-fprd-role-kyvernoecr", karpenter = "lex-mts-fprd-role-karpenter" }
