# Names, policies, security group rules, and tags of the fprd/security root, built here and
...
locals {
  ...
  # Amazon EKS names the control-plane log group itself; fprd/workload creates it first.
