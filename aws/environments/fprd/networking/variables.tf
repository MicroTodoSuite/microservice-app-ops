# Inputs of the fprd/networking root. Account, region, zones, and CIDRs are
...
variable "environment" {
  ...
  validation {
    ...
    error_message = "This root builds fprd only. Another environment would create a second spoke from fprd's state key."
  }
}
...
variable "vpc_cidr" {
  type        = string
  description = "IPv4 address space reserved for the fprd spoke."
