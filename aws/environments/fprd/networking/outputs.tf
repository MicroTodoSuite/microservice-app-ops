# Outputs consumed by fprd/security and fprd/workload, and by the operators.
output "vpc_id" {
  description = "ID of the fprd spoke VPC."
  value       = module.network.vpc_id
}

output "vpc_cidr" {
  description = "IPv4 CIDR block of the fprd spoke."
