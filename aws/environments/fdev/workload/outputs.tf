# Outputs of the fdev/workload root, read by the IRSA pass, the GitOps bootstrap, and kubeconfig.
output "cluster_name" {
  description = "Name of the full-development cluster."
  value       = module.eks_cluster.cluster_name
}

output "cluster_arn" {
  description = "ARN of the full-development cluster."
