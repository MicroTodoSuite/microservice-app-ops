# The fdev/security-irsa root: the second security pass PC-IAC-022 records for IRSA, after
# fdev/workload creates the cluster. It registers the cluster's OIDC issuer in IAM and creates
