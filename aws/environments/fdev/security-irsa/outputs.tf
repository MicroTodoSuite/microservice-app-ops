# Outputs of the fdev/security-irsa root, the role ARNs the GitOps service-account annotations
# take (ops spec 004 T016).
output "oidc_provider_arn" {
  description = "ARN of the IAM OIDC provider of the full development cluster's issuer."
