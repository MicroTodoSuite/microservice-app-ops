...
run "builds_the_irsa_names" {
  ...
  assert {
    condition     = local.oidc_provider_name == "lex-mts-fdev-oidc-eks" && local.irsa_role_names == { jwtdev = "lex-mts-fdev-role-jwtdev", jwtstg = "lex-mts-fdev-role-jwtstg", obssecret = "lex-mts-fdev-role-obssecret", secsecret = "lex-mts-fdev-role-secsecret", trivyecr = "lex-mts-fdev-role-trivyecr", kyvernoecr = "lex-mts-fdev-role-kyvernoecr" }
