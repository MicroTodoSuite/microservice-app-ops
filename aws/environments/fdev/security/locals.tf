# Names, policies, security group rules, and tags of the fdev/security root, built here and
...
locals {
  ...
  # Amazon EKS names the control-plane log group itself; fdev/workload creates it first.
